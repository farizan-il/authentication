    ...
    <script src="http://localhost/zan-template/assets/vendor/libs/apex-charts/apexcharts.js"></script>
    ...
    <!-- Page JS -->
    <script src="http://localhost/zan-template//assets/js/dashboards-analytics.js"></script>
